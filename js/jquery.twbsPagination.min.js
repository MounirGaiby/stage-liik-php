!(function (a, b, c, d) {
    ...
    var e = a.fn.twbsPagination,
        f = function (b, c) {
            ...
            return (
                "UL" === d ? (this.$listContainer = this.$element) : (this.$listContainer = a("<ul></ul>")),
                this.$listContainer.addClass(this.options.paginationClass),
                "UL" !== d && this.$element.append(this.$listContainer),
                this.options.initiateStartPageClick ? this.show(this.options.startPage) : ((this.currentPage = this.options.startPage), this.render(this.getPages(this.options.startPage)), this.setupEvents()),
                this
            );
        };
    (f.prototype = {
